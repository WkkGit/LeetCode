...
public class 小易的英语软件 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < q; i++) {
            ...
            int num = count(scores, scores[index - 1]);
            double res = (num - 1) * 1.0 /n* 100;
            System.out.println(String.format("%.6f",res));//保留6位小数 四舍五入
        }
    }

    public static int count(int[] scores,int target){
        int count = 0;
